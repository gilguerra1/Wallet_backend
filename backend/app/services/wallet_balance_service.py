...
class WalletBalanceService:
    ...
    def __init__(self, wallet_balance_repo: WalletBalanceRepository = None):
        self.wallet_balance_repo = wallet_balance_repo or WalletBalanceRepository()
    ...
    def get_wallet_balances(self, wallet_address: str) -> List[dict]:
        ...
        """
        balances = self.wallet_balance_repo.get_balances_by_wallet_address(wallet_address)
        ...
        for balance in balances:
            result.append({
                ...
                "balance": str(balance["balance"]),  # Convert Decimal to string
